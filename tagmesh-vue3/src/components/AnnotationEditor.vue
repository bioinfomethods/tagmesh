...
import { Annotation } from 'tagmesh'
...
export default defineComponent({
  ...
  methods: {
      showDialog() {
         ...
         this.$nextTick(() => {
             const el : HTMLInputElement = this.$refs.tagName as HTMLInputElement
             el.focus()   
         })
      },
      ...
      editAnnotation(tag : Annotation) {
          this.editedAnnotation.tag = tag.tag
          this.editedAnnotation.notes = tag.notes
          this.editedAnnotation.color = tag.color
          this.editedAnnotation.type = this.type
          this.showDialog()
      },
